      ...
      <section className="section-padding bg-[#f7f7f7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-8">
          <div className="bg-white p-10 border border-[#e4e4e4] text-center card-hover">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#e85242]/10 to-[#f3702b]/10 flex items-center justify-center mx-auto mb-6">
              <Target className="w-8 h-8 text-[#e85242]" />
            </div>
            <h3 className="text-2xl font-bold text-[#3a3d44] mb-4">
              Aming Misyon
            </h3>
            <div className="w-12 h-0.5 bg-gradient-to-r from-[#f3702b] to-transparent mx-auto mb-4" />
          ...
          <div className="bg-white p-10 border border-[#e4e4e4] text-center card-hover">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#f3702b]/10 to-[#e85242]/10 flex items-center justify-center mx-auto mb-6">
              <Eye className="w-8 h-8 text-[#f3702b]" />
            </div>
            <h3 className="text-2xl font-bold text-[#3a3d44] mb-4">
              Aming Bisyon
            </h3>
      ...
      <section className="section-padding bg-[#f7f7f7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-[#f3702b] text-xs uppercase tracking-[0.2em] mb-4 font-medium">Our Values</p>
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {values.map((value) => (
              ...
              >
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#f3702b]/10 to-[#e85242]/10 flex items-center justify-center mx-auto mb-6">
                  <value.icon className="w-8 h-8 text-[#f3702b]" />
                </div>
                <h3 className="text-xl font-bold text-[#3a3d44] mb-3">
                  {value.title}
                </h3>
                <div className="w-10 h-0.5 bg-gradient-to-r from-[#f3702b] to-transparent mx-auto mb-4" />
                <p className="text-[#787878] leading-relaxed">
                  {value.description}
                </p>
              </div>
