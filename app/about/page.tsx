  ...
  return <main>
    ...
    <section className={styles.section}><div className={styles.wrap}><div className={styles.intro}>
      ...
      <div className={styles.visual}>
        ...
        <div className={styles.secondaryVisual}><Image src="/images/logo/731350583_10238772116515608_5057049016834242279_n.jpg" alt="LGBTQIA++ SILBI Kumintang Ilaya Logo" fill sizes="235px" style={{ filter: 'drop-shadow(0 8px 16px rgba(0,0,0,.25))' }} /></div>
      </div>
    </div></div></section>
