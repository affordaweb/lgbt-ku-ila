      ...
      <section className="relative min-h-[700px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-8 leading-tight">
            <span className="font-pacifico">LOVE</span> Ka,<br />
            <span className="text-gradient">Dahil <span className="font-pacifico">Ikaw</span> Ka!</span>
          </h1>
          <p className="text-white/70 max-w-3xl mx-auto mb-6 leading-relaxed text-2xl font-caveat">
