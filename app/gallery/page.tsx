...
export default function GalleryPage() { return <main><HeroSection title="Gallery" subtitle="Home / Gallery" description="A growing visual record of joy, advocacy, creativity, and community." backgroundImage="/images/events/glow-beyond-limits.jpeg" />
