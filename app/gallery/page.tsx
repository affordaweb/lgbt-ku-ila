...
export const metadata: Metadata = pageSeo({ title: "LGBTQIA++ Community Gallery", description: "Explore photos and memories from LGBTQIA++ SILBI Kumintang Ilaya events, gatherings, and celebrations.", path: "/gallery", image: "/images/stock/stock-07.jpg" });
export default function GalleryPage() {
  const breadcrumb=breadcrumbJsonLd([{name:"Home",path:"/"},{name:"Gallery",path:"/gallery"}]);
  return <main><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(breadcrumb)}}/><HeroSection title="Gallery" subtitle="Home / Gallery" description="A growing visual record of joy, advocacy, creativity, and community." backgroundImage="/images/stock/stock-07.jpg" />
