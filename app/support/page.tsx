...
export default function SupportPage() { return <main>
  <HeroSection title="Support Us" subtitle="Home / Support Us" description="Every contribution becomes practical care, joyful gathering, and stronger support for our community." backgroundImage="/images/events/laso-photo-contest.jpeg" />
