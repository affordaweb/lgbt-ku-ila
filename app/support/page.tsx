...
export default function SupportPage() { return <main>
  ...
  <section className={`${styles.section} ${styles.cream}`}><div className={styles.wrap}><div className={styles.intro}>
    <div className={styles.copy}><p className={styles.eyebrow}>Make a difference</p><h2 className={styles.heading}>Give what you can.<br />Help someone <em>belong.</em></h2><p>Your donation helps sustain the programs and services that empower LGBTQIA++ people in Kumintang Ilaya. Bawat piso ay nagiging pag-asa at lakas para sa komunidad.</p><div className={styles.featureList}><div className={styles.feature}><span className={styles.featureIcon}><Gift size={18}/></span><div><b>Donate via InstaPay or GCash</b>Scan the QR code to choose an amount and send your contribution.</div></div><div className={styles.feature}><span className={styles.featureIcon}><Shield size={18}/></span><div><b>Transparent by design</b>We are committed to honest reporting on the resources entrusted to our community.</div></div></div><div className={styles.actions}><Link className={styles.primaryButton} href="/contact">Ask about donating <ArrowRight size={16}/></Link><Link className={styles.secondaryButton} href="/pride-partners">Our Pride Partners <ArrowRight size={16}/></Link></div></div>
    <div className={styles.visual}><div className={styles.primaryVisual}><Image src="/images/instapay-qr.png" alt="InstaPay QR code for Ku-Ila donations" fill sizes="(max-width:820px) 82vw, 520px" className="object-contain bg-white p-5" /></div><div className={styles.secondaryVisual}><Image src="/images/events/batangas-city-queen-screening.jpeg" alt="Ku-Ila community gathering" fill sizes="235px" /></div></div>
  </div></div></section>
