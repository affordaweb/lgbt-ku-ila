...
export const metadata: Metadata = pageSeo({ title: "LGBTQIA++ Ku-Ila Members", description: "Meet the members, leaders, organizers, and advocates of LGBTQIA++ SILBI Kumintang Ilaya in Batangas City.", path: "/members", image: "/images/stock/stock-08.jpg" });
export default function MembersPage() { return <main><HeroSection title="Our Members" subtitle="Home / Members" description="The people who listen, organize, advocate, and make safer spaces possible." backgroundImage="/images/stock/stock-08.jpg" />
