...
export default function TransparencyPage() { return <main>
  <HeroSection title="Transparency" subtitle="Home / About / Transparency" description="Accountability, honesty, and care for the trust our community places in us." backgroundImage="/images/events/batangas-city-queen-screening.jpeg" />
