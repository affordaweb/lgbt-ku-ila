...
export const metadata: Metadata = pageSeo({ title: "Transparency and Accountability", description: "Learn about Ku-Ila's commitment to transparency, accountability, and care for community resources in Batangas City.", path: "/transparency", image: "/images/stock/stock-12.jpg" });
