...
export default function PridePartnersPage() {
  ...
  return <main className={styles.page}>
    ...
    <section className={styles.quote}><div className={styles.wrap}><div className={styles.quotePanel}><div className={styles.quoteAside}><p className={styles.eyebrow}>Our shared promise</p><span>01 — Together</span></div><div className={styles.quoteContent}><span className={styles.quoteMark} aria-hidden="true">“</span><blockquote>Pride grows when people choose to stand beside the community. Every form of support—large or small—helped create a celebration where people could be <em>seen, heard, and welcomed.</em></blockquote><p>With gratitude to every person who helped make room for belonging.</p></div></div></div></section>
    ...
    <section className={styles.gallery}><div className={styles.wrap}><p className={styles.eyebrow}>Pride March memories</p><h2>The celebration their support<br />helped <em>bring to life.</em></h2><div className={styles.galleryGrid}><figure><Image src="/images/events/734896841_1747334810026168_6985617327012982623_n.jpg" alt="Ku-Ila members at a Pride Month gathering" fill sizes="(max-width: 760px) 100vw, 31vw" /></figure><figure><Image src="/images/events/734685130_2070636223809499_996300586797761429_n.jpg" alt="Ku-Ila members celebrating an award at a Batangas City event" fill sizes="(max-width: 760px) 100vw, 31vw" /></figure><figure><Image src="/images/events/734768224_2070636277142827_2921723697569089008_n.jpg" alt="Ku-Ila members together at a Batangas City Pride event" fill sizes="(max-width: 760px) 100vw, 31vw" /></figure></div></div></section>
